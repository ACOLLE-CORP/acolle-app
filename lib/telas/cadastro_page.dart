      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            // FIX: SizedBox(height: 62) fixo trocado por
            // ConstrainedBox(minHeight: 62) para o botão crescer com o
            // texto em vez de estourar quando a fonte do sistema é
            // ampliada (comum em configurações de acessibilidade).
            ConstrainedBox(
              constraints: const BoxConstraints(minHeight: 62, minWidth: double.infinity),
